...
export interface Setting {
  id: number;
  attributes: {
    createdAt: Date;    updatedAt: Date;    publishedAt?: Date;    notification: NotificationTemplate[];
...
export interface Setting_Plain {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  notification: NotificationTemplate_Plain[];
...
export interface Setting_NoRelations {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  notification: NotificationTemplate_NoRelations[];
